        ...
        init: function(g) {
            ...
            return q.setTheme("ace/theme/" + i.theme), q.getSession().setMode("ace/mode/markdown"), q.getSession().setUseWrapMode(!0), q.getSession().setUseSoftTabs(i.softTabs), q.getSession().on("change", function() {
                ...
                var b = a(this).data("btn"),
                    ...
                    "keepFormat" === b ? q. e(q, "```") : "h1" === b ? e(q, "#") : "h2" === b ? e(q, "##") : "h3" === b ? e(q, "###") : "ul" === b ? e(q, "*") : "ol" === b ? e(q, "1.") : "bold" === b ? q.execCommand("bold") : "italic" === b ? q.execCommand("italic") : "link" === b ? q.execCommand("link") : "image" === b ? "" === d ? p.insertSnippet(q, "![${1:text}](http://$2)") : p.insertSnippet(q, "![" + d + "](http://$1)") : "edit" === b ? (k = !1, n.hide(), m.show(), h.find(".btn-edit").addClass("active"), h.find(".btn-preview").removeClass("active"), l === !0 && c(m)) : "preview" === b ? (k = !0, n.html('<pre style="text-align:center; font-size:16px">' + i.label.loading + "...</pre>"), i.onPreview(q.getSession().getValue(), function(a) {
                    n.html(a);
